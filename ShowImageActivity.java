...
public class ShowImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strPhoto = "";
        String strImgPath = getIntent.getStringExtra("imgpath");
        final String[] arrayphoto = strImgPath.split("/");
        strPhoto = strImgPath ;

        if(strPhoto.equals("null") || strPhoto.equals("")){
            Toast.makeText(ShowImageActivity.this, "暂无图片！", Toast.LENGTH_SHORT).show();
            activity.finish();
        }else {
            bugPhoto = strPhoto.replace("，",",").split(",");
            proDialog = ProgressDialog.show(ShowImageActivity.this, "", "加载中，请稍候...");
                ...
                public void run() {
                    try {
                        ...
                        if (arrayphoto.length > 1) {
                            ...
                            p = wurl + URLEncoder.encode(photoname, "UTF-8") + ".jpg";
                            bitmap = PostParamTools.getHttpBitmap(p);
                        }
                        newPhoto[0] = p;
                        ...
                        proDialog.dismiss();
                        Toast.makeText(ShowImageActivity.this, "图片加载失败！", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
    ...
    public void setViewPager(){
        ...
        adapter = new PagerAdapter(){
            ...
            public Object instantiateItem(ViewGroup container,final int position){
                ...
                final ImageView im = new ImageView(ShowImageActivity.this);
                ...
                attacher.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        // 相应长按事件弹出菜单
                        final ItemLongClickedPopWindow itemLongClickedPopWindow = new ItemLongClickedPopWindow(ShowImageActivity.this,
     ...
     * **/
    final MediaScannerConnection msc = new MediaScannerConnection(ShowImageActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
