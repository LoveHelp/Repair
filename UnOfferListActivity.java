...
public class UnOfferListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_un_offer_list);

        if(repairuserid.equals("")){
            Intent intent = new Intent(UnOfferListActivity.this,LoginActivity.class);
    ...
    private void InitControl(){
        ...
        if(upd==1){
            tv_title.setText("已报价故障列表");
        }else {
            tv_title.setText("待报价故障列表");
        }
    }
    ...
    private void InitControlEvent(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent = new Intent(UnOfferListActivity.this,UnOfferDetailActivity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    //请求数据失败
                    listView.setAdapter(null);
                    Toast.makeText(UnOfferListActivity.this, "请求数据失败...", Toast.LENGTH_LONG).show();
                    listView.setVisibility(View.GONE);
                    ll_nodata.setVisibility(View.VISIBLE);
                ...
                case 3:
                    ...
                    myAdapter = new MyAdapter(UnOfferListActivity.this, datalist);
                ...
                case 5:
                    ...
                    //Toast.makeText(UnOfferListActivity.this, "网络链接超时...", Toast.LENGTH_LONG).show();
                    break;
            }
