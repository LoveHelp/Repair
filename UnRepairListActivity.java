...
public class UnRepairListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_un_repair_list);

        if(repairuserid.equals("")){
            Intent intent = new Intent(UnRepairListActivity.this,LoginActivity.class);
    ...
    private void InitControl(){
        ...
        if(upd==1){
            tv_title.setText("已排查故障列表");
        }else {
            tv_title.setText("待排查故障列表");
        }
    }
    ...
    private void InitControlEvent(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent = new Intent(UnRepairListActivity.this,UnRepairDetailActivity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    //请求数据失败
                    listView.setAdapter(null);
                    Toast.makeText(UnRepairListActivity.this, "请求数据失败...", Toast.LENGTH_LONG).show();
                    listView.setVisibility(View.GONE);
                    ll_nodata.setVisibility(View.VISIBLE);
                ...
                case 3:
                    ...
                    myAdapter = new MyAdapter(UnRepairListActivity.this, datalist);
                ...
                case 5:
                    ...
                    //Toast.makeText(UnRepairListActivity.this, "网络链接超时...", Toast.LENGTH_LONG).show();
                    break;
            }
